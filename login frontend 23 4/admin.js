document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auth check - redirect if not an admin
    if (!token || role !== 'ADMIN') {
    ...
    const loadJobs = async () => {
        try {
            ...
            loadingJobsIndicator.innerHTML = `<div class="alert alert-danger">Failed to load jobs.</div>`;
        }
    };
    ...
    const loadUsers = async () => {
        try {
            ...
            loadingUsersIndicator.innerHTML = `<div class="alert alert-danger">Failed to load users.</div>`;
        }
    };
