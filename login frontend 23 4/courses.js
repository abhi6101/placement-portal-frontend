document.addEventListener('DOMContentLoaded', () => {
    const allCourses = [
        { id: 3, title: "Python for Beginners to Advanced", description: "Master Python with projects, data structures, and OOP. Your complete guide to becoming a Python pro.", image: "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80", duration: "6 Weeks", students: 2400, level: "Beginner", category: "programming", link: "#" },
        { id: 4, title: "Full Stack Web Development", description: "Build complete web applications from scratch using the MERN stack (MongoDB, Express, React, Node.js).", image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&q=80", duration: "10 Weeks", students: 1500, level: "Intermediate", category: "web-dev", link: "#" },
